...
- oversampled young women 25-34 and undersampled men 35-44 and men 45-54. We have also oversampled men 55-64 and, to a lesser degree, men 65+ while undersampling women 65+.
...
sum_man_aug <- round(summary(weights_aug_strata$weight), 2)
...
sum_man_feb <- round(summary(weights_feb_strata$weight), 2)
